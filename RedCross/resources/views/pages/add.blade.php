    ...
    <div class="col-lg-12">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
              ...
              <center><h3>  Add Acceptor Details </h3></center>
            </div>
            <div class="panel-body">
                <form action="{{ route('pages.insert') }}" method="POST" class="form-horizontal">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="phoneno" id="phoneno" class="form-control" maxlength="10" pattern="\d{10}" title="Please enter exactly 10 digits" autocomplete="off" required>
                        </div>
                    </div>
                    <div class="form-group">
